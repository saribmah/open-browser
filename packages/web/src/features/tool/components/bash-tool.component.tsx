...
import { Terminal, ChevronRight, CheckCircle2, Loader2, Circle } from "lucide-react"
...
/**
 * Bash tool component that displays command execution information
 */
          ...
          <div className="border border-zinc-800/50 rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0 flex-1">
                {getStatusIcon()}
                <Terminal className="h-4 w-4 flex-shrink-0 text-orange-400" />
            ...
            >
              <div className="min-h-0">
                <div className="p-3 font-mono text-xs bg-zinc-950">
                  {/* Command input with terminal prompt styling */}
