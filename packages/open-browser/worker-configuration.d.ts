/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d9efb39cc7920f17d8458e96bb6f1970)
// Runtime types generated with workerd@1.20251118.0 2025-11-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SandboxManager" | "CloudflareSandbox";
	}
	interface Env {
		HOSTNAME: "open-browser.com";
		API_HOST: "open-browser.com";
		SANDBOX_IMAGE_NAME: "open-browser-sandbox";
		SANDBOX_SERVER_PORT: "3097";
		DEFAULT_SANDBOX_PROVIDER: "cloudflare";
		DAYTONA_IMAGE_TAG: "0.1.0";
		DAYTONA_API_URL: string;
		DAYTONA_API_KEY: string;
		CLOUDFLARE_SANDBOX: DurableObjectNamespace<import("./src/index").CloudflareSandbox>;
		SANDBOX_MANAGER: DurableObjectNamespace<import("./src/index").SandboxManager>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOSTNAME" | "API_HOST" | "SANDBOX_IMAGE_NAME" | "SANDBOX_SERVER_PORT" | "DEFAULT_SANDBOX_PROVIDER" | "DAYTONA_IMAGE_TAG" | "DAYTONA_API_URL" | "DAYTONA_API_KEY">> {}
}
